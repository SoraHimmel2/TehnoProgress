      ...
      <div className='mx-6 py-10 text-left '>
        <div className='flex flex-col justify-center gap-10 sm:grid sm:grid-cols-1 md:flex md:flex-row '>
          ...
          <div className='flex flex-col items-start  border-black'>
            ...
            <div className='mb-2 flex-col flex-wrap font-sans'>
          ...
          <div className='mt-12 flex-col  border-black lg:flex-none'>
            ...
            <div className='flex flex-col items-start gap-8 lg:flex-row'>
              <div>
                <div className='flex-col  flex-wrap font-sans'>
              ...
              <div>
                <div className='mb-2 w-80 flex-col flex-wrap font-sans'>
                  <div className=''>
                    Расчетный счет: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                  </div>
                  <div className=' '>40702810403000066173</div>
                </div>
                <div className='mb-2 flex w-80 flex-col flex-wrap font-sans'>
