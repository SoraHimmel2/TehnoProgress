  ...
  return (
    <footer className='bg-gray-100 text-center text-gray-600 lg:text-left'>
      ...
      <div className='mx-6  py-10 text-center md:text-left'>
        <div className='grid-1 justify-items-between  grid gap-8  md:grid-cols-2 lg:grid-cols-5'>
          <div className=''>
          ...
          <div className='ml-12'>
            <h6 className='mb-4 mr-96 flex  font-semibold uppercase '>
              &nbsp;
            </h6>
          ...
          <div className=''>
            <h6 className=' mb-10 flex w-60 justify-start font-semibold uppercase'>
              &nbsp;
            </h6>
            <div className='mb-4'>
              <div className='text-left'>
          ...
          <div className=''>
            <h6 className=' mb-10 flex  justify-start font-semibold uppercase'>
              &nbsp;
            </h6>
            <div className='mb-10'>
              <div className='text-left '>
